...
target.compileFonts = function () {
    var fontsDir = 'cartridges/int_contentstack/cartridge/static/default/fonts';
    mkdir('-p', fontsDir);
    cp('-r', '../../node_modules/font-awesome/fonts/', 'cartridges/int_contentstack/cartridge/static/default');
